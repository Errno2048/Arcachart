...
if __name__ == '__main__':
    ...
    parser.add_argument('--arc-group-tolerance', '-t', type=int, default=10,
    ...
    parser.add_argument('--draw-black-line', '-b', action='store_true', help='To draw black lines.')
    ...
    preset.draw_black_line = args.draw_black_line
